...
**能推断的不追问。** 用户说了"3个人吃饭"，直接映射到 3 小时规格，不再展示选项让用户选。用户说了"明天中午"，直接解析为明天 11:30 去查档期，不追问"请问具体几点"。
